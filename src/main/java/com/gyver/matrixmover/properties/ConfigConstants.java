...
public final class ConfigConstants {
    ...
    public static final String DISPLAY_PIXEL_WIDTH = "display.pixel.size.width";
    public static final String DISPLAY_PIXEL_HEIGHT = "display.pixel.size.height";
    public static final String DISPLAY_PIXEL_SPACE = "display.pixel.space";
    public static final String OUTPUT_DIMENSION_WIDTH = "output.resolution.width";
