 ...
 * @author Gyver
 */
public class Max extends Mixer {
    ...
    public int[] getBuffer(int[] src1, int[] src2) {
        ...
        for (int i = 0; i < src1.length; i++) {
            ...
            redDest = (short) Math.max(redDest, redSource);
            greenDest = (short) Math.max(greenDest, greenSource);
            blueDest = (short) Math.max(blueDest, blueSource);
